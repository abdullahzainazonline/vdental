...
export const DENTISTS = [
  {
    ...
    image: 'https://vdental.com.my/wp-content/uploads/2024/04/Dr-Veron-2-Light-Bg.png',
  },
  {
    id: 2,
    name: 'Dr. Penny',
...
export const GALLERY_ITEMS = [
  {
    id: 1,
    category: "Cosmetic",
    title: "Porcelain Crowns — Replacing Old PFM Crowns",
    description: "Replacing old PFM crowns with full porcelain crowns to restore aesthetics.",
    before: "https://vdental.com.my/wp-content/uploads/2024/04/Case-1_-Before.png",
    after: "https://vdental.com.my/wp-content/uploads/2024/04/Case-1_-Aftrer.png",
  },
  {
    id: 2,
    category: "Braces",
    title: "Self-Ligating Braces — Teeth Alignment",
    description: "Proclination of upper teeth corrected with self-ligating braces, giving a dashing smile and stunning side profile.",
    before: "https://vdental.com.my/wp-content/uploads/2024/04/Case-2_-Before.png",
    after: "https://vdental.com.my/wp-content/uploads/2024/04/Case-2_-After.png",
  },
  {
    id: 3,
    category: "Cosmetic",
    ...
    before: "https://vdental.com.my/wp-content/uploads/2024/04/Case-4_-Before.png",
    after: "https://vdental.com.my/wp-content/uploads/2024/04/Case-4_-After.png",
  },
  {
    id: 4,
    category: "Smile Makeover",
    title: "Full Mouth Rehabilitation",
    description: "Invisalign clear aligners + porcelain crowns + veneers + dental implant for a complete transformation.",
    before: "https://vdental.com.my/wp-content/uploads/2024/04/Case-5-Before.png",
    after: "https://vdental.com.my/wp-content/uploads/2024/04/Case-5-After.png",
  },
  {
    id: 5,
    category: "Implants",
    title: "Dental Implant — Missing Tooth Replacement",
    description: "Dental implant to replace a missing tooth, restoring function and aesthetics.",
    before: "https://vdental.com.my/wp-content/uploads/2024/05/Implant-Before.png",
    after: "https://vdental.com.my/wp-content/uploads/2024/05/Implant-After.png",
  },
  {
    id: 6,
    category: "General",
    title: "Dental Filling — Chipped Tooth Restoration",
    description: "Restoring a huge chipped tooth with aesthetic composite filling.",
    before: "https://vdental.com.my/wp-content/uploads/2024/04/Case-7_-Before.png",
    after: "https://vdental.com.my/wp-content/uploads/2024/04/Case-7_-After.png",
  },
  {
    id: 7,
    category: "Cosmetic",
    title: "Crown and Bridge — Zirconia Restoration",
    description: "Beautiful smile restored with zirconia crown and bridge. Regaining confidence is priceless.",
    before: "https://vdental.com.my/wp-content/uploads/2024/04/Case-8_-Before.png",
    after: "https://vdental.com.my/wp-content/uploads/2024/04/Case-8_-After.png",
  },
  {
    id: 8,
    category: "Smile Makeover",
    title: "Braces & Porcelain Veneers Makeover",
    description: "Transforming smile with braces to correct misaligned teeth followed by porcelain veneers for heavy fluorosis.",
    before: "https://vdental.com.my/wp-content/uploads/2024/04/Case-9_-Before-2.png",
    after: "https://vdental.com.my/wp-content/uploads/2024/04/Case-9_-After-2.png",
  },
  {
    id: 9,
    category: "Braces",
    title: "Gummy Smile Treatment with Braces & TADs",
    description: "Gummy smile and slanted smile corrected with braces and bone screws (TADs), restoring a confident smile.",
    before: "https://vdental.com.my/wp-content/uploads/2024/04/Case-10_-Before-1.png",
    after: "https://vdental.com.my/wp-content/uploads/2024/04/Case-10_-After-1.png",
  },
];
